    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gh_stars', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chart_link', models.CharField(blank=True, max_length=400, null=True)),
                ...
                ('status', models.CharField(choices=[(1, 'Draft'), (2, 'Published post')], default=1, max_length=32)),
